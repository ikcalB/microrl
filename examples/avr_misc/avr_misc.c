...
void print_help(void* pThis, void)
{
	...
	print(
	    pThis,
	    "\tset_port port pin   - set 1 port[pin] value, support only "
	    "'port_b' and 'port_d'\n\r");
	print(
	    pThis,
	    "\tclear_port port pin - set 0 port[pin] value, support only "
	    "'port_b' and 'port_d'\n\r");
}
